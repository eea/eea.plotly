pipeline {
  ...
  environment {
        GIT_NAME = "eea.plotly"
        SONARQUBE_TAGS = "www.eea.europa.eu,biodiversity.europa.eu,industry.eea.europa.eu,forest.eea.europa.eu,demo-www.eea.europa.eu,www.eea.europa.eu-en,demo-ied.eea.europa.eu,www.ied.eea.europa.eu-en,demo-water.devel5cph.eea.europa.eu-freshwater,water.europa.eu-freshwater"
    }
